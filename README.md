...
* If future Chef runs done by the system fail to sign into Mas, it may be necessary to sign in
as root manually.

```
$ sudo mas signin user@domain.com
...
$ sudo  mas signin user@domain.com
==> Signing in to Apple ID: user@domain.com
Password: <Apple ID password + 2FA code generated by previous login attempt>
```
